...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Links oficiais, propostas e trajetória de Wellington Oliveira.",
      },
      { name: "author", content: "Wellington Oliveira" },
    ...
    links: [
      ...
      { rel: "icon", href: logoWellingtonOliveira, type: "image/png" },
    ],
  }),
